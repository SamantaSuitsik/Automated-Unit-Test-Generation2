...
public class GTv2 {
	...
	public void testCreatesNextDate14() throws Throwable {
	    ...
	    String string0 = nextDate0.run(5, 5, 1827);
	    assertEquals("5/6/1827", string0);
	}
	...
	public void testCreatesNextDate15() throws Throwable {
	    ...
	    String string0 = nextDate0.run(8, 30, 1827);
	    assertEquals("8/31/1827", string0);
	}
	...
	public void testCreatesNextDate8() throws Throwable {
	    ...
	    String string0 = nextDate0.run(7, 28, 1901);
	    assertEquals("7/28/1901", string0);
	}
	...
	public void testCreatesNextDate11() throws Throwable {
	    NextDate nextDate0 = new NextDate(28, 28, 28);
	    String string0 = nextDate0.run(2, 28, 1920);
	    assertEquals("2/29/1920", string0);
	}

	@Test(timeout = 4000)
	public void testRunReturningNonEmptyString() throws Throwable {
	    NextDate nextDate0 = new NextDate(28, 28, 28);
	    String string0 = nextDate0.run(2, 28, 1901);
	    assertEquals("3/1/1901", string0);
	}
